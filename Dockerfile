...
# 2022-02-04T02:37:48Z
ARG ROOTLESSKIT_COMMIT=11642004424410ab18bbbbd195d397f2514c5060
# 2022-03-01T23:04:07Z
ARG CONTAINERD_COMMIT=2a3f1094a4684222ffc1078a171fda9bc650eac5
# 2022-03-01T19:52:38Z
ARG CRIO_COMMIT=d936534651ae6e324c8ea000c76c8b960bc3fd52

ARG KUBE_NODE_COMMIT=v1.24.0-alpha.3

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.2.0-beta.0
ARG CONMON_RELEASE=2.1.0
ARG CRUN_RELEASE=1.4.2
ARG FUSE_OVERLAYFS_RELEASE=v1.8.2
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.24.0-alpha.3
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.24.0-usernetes
ARG CNI_PLUGINS_RELEASE=v1.1.0
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.0.1
ARG FLANNEL_RELEASE=v0.16.3
ARG ETCD_RELEASE=v3.5.2
