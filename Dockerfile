...
# 2022-06-08T02:20:01Z
ARG ROOTLESSKIT_COMMIT=82e755a905e0571ff206b1e8b62198155cf57dc2
# 2022-06-10T22:59:42Z
ARG CONTAINERD_COMMIT=a5d7185c72ba7f0b24f762b78fe8d54794465c42
# 2022-06-10T12:54:49Z
ARG CRIO_COMMIT=cd597a8603faaef2a782736610f8380f7458e875

ARG KUBE_NODE_COMMIT=v1.24.1

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.2.0
ARG CONMON_RELEASE=2.1.1
ARG CRUN_RELEASE=1.4.5
ARG FUSE_OVERLAYFS_RELEASE=v1.9
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.24.1
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.24.1-usernetes
ARG CNI_PLUGINS_RELEASE=v1.1.1
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.1.0
ARG FLANNEL_RELEASE=v0.18.1
