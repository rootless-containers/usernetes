...
# 2022-06-24T18:54:03Z
ARG ROOTLESSKIT_COMMIT=b3be645bd3d1e60475904e5e41d66e674ee60b44
# 2022-07-14T15:54:19Z
ARG CONTAINERD_COMMIT=470ebf44999748cb4ec69986ba8659b0b9813ff3
# 2022-07-14T21:32:02Z
ARG CRIO_COMMIT=f794a633aedb9673a88418fffcb253f437bbb911

ARG KUBE_NODE_COMMIT=v1.24.3

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.2.0
ARG CONMON_RELEASE=2.1.2
ARG CRUN_RELEASE=1.4.5
ARG FUSE_OVERLAYFS_RELEASE=v1.9
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.24.3
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.24.3-usernetes
