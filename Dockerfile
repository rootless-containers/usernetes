...
# 2022-08-15T23:02:30Z
ARG ROOTLESSKIT_COMMIT=2923e98dbd7db7e9b32329ecdecd2a8ab8fedf36
# 2022-08-24T00:35:40Z
ARG CONTAINERD_COMMIT=542e4b219d8c3516e236fe73539926c27ee6846d
# 2022-08-24T03:54:50Z
ARG CRIO_COMMIT=313cfd873dc51eb7fe61af2f4a5957e1d9ec4258

ARG KUBE_NODE_COMMIT=v1.25.0

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.2.0
ARG CONMON_RELEASE=2.1.3
ARG CRUN_RELEASE=1.5
ARG FUSE_OVERLAYFS_RELEASE=v1.9
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.25.0
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.25.0-usernetes
ARG CNI_PLUGINS_RELEASE=v1.1.1
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.1.0
ARG FLANNEL_RELEASE=v0.19.1
