...
# 2022-09-23T16:27:53Z
ARG ROOTLESSKIT_COMMIT=5ec578662e2c9a10b28036d2dd5d83533aaad0e9
# 2022-10-07T07:22:14Z
ARG CONTAINERD_COMMIT=6fcfcf3a890e1730ac211ad30abacae6feae0b2b
# 2022-10-07T07:52:54Z
ARG CRIO_COMMIT=3aab4a2fe508fe84e33fc66c21fd0d58c89e8ae1

ARG KUBE_NODE_COMMIT=v1.25.2

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.2.0
ARG CONMON_RELEASE=2.1.4
ARG CRUN_RELEASE=1.6
ARG FUSE_OVERLAYFS_RELEASE=v1.9
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.25.2
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.25.2-usernetes
ARG CNI_PLUGINS_RELEASE=v1.1.1
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.1.0
ARG FLANNEL_RELEASE=v0.19.2
ARG ETCD_RELEASE=v3.5.5
