...
# 2021-11-18T10:46:37Z
ARG ROOTLESSKIT_COMMIT=37262453b3f6d9cc7e4726f506c002b6fd98ab82
# 2022-01-03T21:20:29Z
ARG CONTAINERD_COMMIT=07aa42f427f595337c33a9d0eb33c4d51b96a0fe
# 2021-12-17T02:17:47Z
ARG CRIO_COMMIT=9b7f5ae815c22a1d754abfbc2890d8d4c10e240d

ARG KUBE_NODE_COMMIT=v1.24.0-alpha.1

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.1.12
ARG CONMON_RELEASE=2.0.31
ARG CRUN_RELEASE=1.4
ARG FUSE_OVERLAYFS_RELEASE=v1.8
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.4
ARG KUBE_MASTER_RELEASE=v1.24.0-alpha.1
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.24.0-usernetes
ARG CNI_PLUGINS_RELEASE=v1.0.1
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.0.0
ARG FLANNEL_RELEASE=v0.15.1
